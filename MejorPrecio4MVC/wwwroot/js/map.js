...
function initMap() 
{
    var map = new google.maps.Map(document.getElementById('map'), {
        zoom: 11,
        center: {lat: -34.5888126, lng: -58.4310352}
        });
    var locations = [{lat : -34.5 , lng : -58}];
    var URLactual = window.location;
    var loc = URLactual.pathname.substring(URLactual.pathname.lastIndexOf("/")+1);

    $.get("/Price/Coordinates/" + loc, function(data){
        loadPrice(data,map);
    });
